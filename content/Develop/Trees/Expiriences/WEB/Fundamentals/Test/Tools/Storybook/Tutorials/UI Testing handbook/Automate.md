...
![](https://storybook.js.org/tutorials/ui-testing-handbook/image-19.png)
...
| ![get project token from Chromatic](https://storybook.js.org/tutorials/ui-testing-handbook/get-token.png) | ![add secret to your repository](https://storybook.js.org/tutorials/ui-testing-handbook/add-secret.png) |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |

Finally, create a new commit, push your changes to GitHub, and you should see your workflow in action!

![](https://storybook.js.org/tutorials/ui-testing-handbook/image-21.png)
...
![](https://storybook.js.org/tutorials/ui-testing-handbook/image-22.png)
...
<a href="https://github.com/chromaui/learnstorybook.com/blob/master/content/ui-testing-handbook/react/en/automate.md" target="_blank" rel="noopener" class="e1i3hdtx0 e1ja7avb2 css-1ii1tfm e1ja7avb1"><span class="css-1xdhyk6 e1ja7avb3"><span role="img" aria-label="write">✍️</span> <!-- -->Edit on GitHub – PRs welcome!</span></a>
