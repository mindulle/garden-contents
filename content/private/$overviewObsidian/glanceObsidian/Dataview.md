...
Exactly the same as dv.query`, but more convienent in short scripts as execution failures will be raised as JavaScript exceptions instead of a result type.
